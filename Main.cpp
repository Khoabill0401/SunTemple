...
void AMain::BeginPlay()
{
	...
	//UKismetSystemLibrary::DrawDebugSphere(this, GetActorLocation() + FVector(0,0,175.f), 25.f, 8, FLinearColor::Red, 5.f, .5f);
...
void AMain::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Move Forward/Backward", this, &AMain::MoveForward);
	PlayerInputComponent->BindAxis("Move Right/Left", this, &AMain::MoveRight);
...
void AMain::ShowPickupLocations()
{
	...
	//{
	//	UKismetSystemLibrary::DrawDebugSphere(this, PickupLocations[i], 25.f, 8, FLinearColor::Red, 5.f, .5f);
	//}

	for (FVector Location : PickupLocations)
	{
		UKismetSystemLibrary::DrawDebugSphere(this, Location, 25.f, 8, FLinearColor::Red, 5.f, .5f);
	}
}
*/
void AMain::LMBDown()
	...
	if (!bAttacking && MovementStatus != EMovementStatus::EMS_Dead)
	{
		...
		if (AnimInstance && CombatMontage)
		{
			...
			case 0:
				...
				AnimInstance->Montage_JumpToSection(FName("Attack_Combo"), CombatMontage);
				break;
			case 1:
...
void AMain::LoadGameNoSwitch()
{
	...
	if (WeaponStorage)
	{
		...
		if (Weapons)
		{
			...
			/* These lines of codes are not working correctly
